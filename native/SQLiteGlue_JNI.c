/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Mon Oct 21 23:23:49 CEST 2013 ----! */
...
/*   Java->C glue code:
 *   Java package: org.sulite.SQLiteGlue
 *    Java method: int sqlg_db_close(long db)
 *     C function: int sqlg_db_close(ptrdiff_t db);
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1db_1close__J(JNIEnv *env, jclass _unused, jlong db) {
  int _res;
...
Java_org_sulite_SQLiteGlue_sqlg_1db_1open__Ljava_lang_String_2I(JNIEnv *env, jclass _unused, jstring filename, jint flags) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1db_1prepare_1st__JLjava_lang_String_2(JNIEnv *env, jclass _unused, jlong db, jstring sql) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1bind_1double__JID(JNIEnv *env, jclass _unused, jlong st, jint col, jdouble val) {
  int _res;
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1bind_1int__JII(JNIEnv *env, jclass _unused, jlong st, jint col, jint val) {
  int _res;
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1bind_1int64__JIJ(JNIEnv *env, jclass _unused, jlong st, jint col, jlong val) {
  int _res;
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1bind_1text__JILjava_lang_String_2(JNIEnv *env, jclass _unused, jlong st, jint col, jstring val) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1column_1count__J(JNIEnv *env, jclass _unused, jlong st) {
  int _res;
...
Java_org_sulite_SQLiteGlue_sqlg_1st_1column_1name__JI(JNIEnv *env, jclass _unused, jlong st, jint col) {
  const char *  _res;
 ...
 */
JNIEXPORT jstring JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1column_1text__JI(JNIEnv *env, jclass _unused, jlong st, jint col) {
  const char *  _res;
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1column_1type__JI(JNIEnv *env, jclass _unused, jlong st, jint col) {
  int _res;
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1finish__J(JNIEnv *env, jclass _unused, jlong st) {
  int _res;
 ...
 */
JNIEXPORT jint JNICALL 
Java_org_sulite_SQLiteGlue_sqlg_1st_1step__J(JNIEnv *env, jclass _unused, jlong st) {
  int _res;
